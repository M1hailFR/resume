...
export default {
  ...
  resume: {
    ...
    services: {
      title: "Услуги",
      service1: {
        title: "Разработка SPA/PWA",
        text: "Создание современных одностраничных приложений и прогрессивных веб-приложений с офлайн-поддержкой",
      },
      service2: {
        title: "Верстка по дизайну",
        text: "Точная реализация макетов из Figma с вниманием к деталям, анимациям и адаптивности",
      },
      service3: {
        title: "Оптимизация",
        text: "Улучшение производительности, SEO, доступности и метрик Core Web Vitals",
      },
      service4: {
        title: "Поддержка",
        text: "Техническая поддержка существующих проектов, исправление багов, доработка функционала",
      },
    },
  },
};
